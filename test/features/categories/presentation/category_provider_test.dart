...
void main() {
  ...
  group('expenseParentsProvider', () {
    test('given expense parents exist, '
        'when reading provider, '
        'then returns expense parent list', () async {
      final parents = [
        _makeCategory(),
  ...
  group('incomeParentsProvider', () {
    test('given income parents exist, '
        'when reading provider, '
        'then returns income parent list', () async {
      final parents = [
  ...
  group('childrenProvider', () {
    test('given parent has children, '
        'when reading childrenProvider(parentId), '
        'then returns children', () async {
      final children = [
